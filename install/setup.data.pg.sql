...
DELETE FROM "{PREFIX}keyword_xref"  WHERE content_id = 3 AND keyword_id = 1;
INSERT INTO "{PREFIX}keyword_xref"(content_id, keyword_id) VALUES (3, 1);


DELETE FROM "{PREFIX}keyword_xref"  WHERE content_id = 4 AND keyword_id = 1;
INSERT INTO "{PREFIX}keyword_xref"(content_id, keyword_id) VALUES (1, 1);
...
DELETE FROM "{PREFIX}document_groups" WHERE "id" = 1;
INSERT INTO "{PREFIX}document_groups"("id", "document_group", "document") VALUES (1, 1, 3);


DELETE FROM "{PREFIX}documentgroup_names" WHERE "id" = 1;
INSERT INTO "{PREFIX}documentgroup_names"("id", "name", "private_memgroup", "private_webgroup") VALUES (1, 'Site Admin Pages', 0,0);
...
DELETE FROM "{PREFIX}site_keywords" WHERE "id" = 1;
INSERT INTO "{PREFIX}site_keywords" VALUES ('1','MODx');


DELETE FROM "{PREFIX}site_keywords" WHERE "id" = 2;
INSERT INTO "{PREFIX}site_keywords" VALUES ('2','content management system');


DELETE FROM "{PREFIX}site_keywords" WHERE "id" = 3;
INSERT INTO "{PREFIX}site_keywords" VALUES ('3','Front End Editing');


DELETE FROM "{PREFIX}site_keywords" WHERE "id" = 4;
INSERT INTO "{PREFIX}site_keywords" VALUES ('4','login');
...
DELETE FROM "{PREFIX}site_tmplvar_contentvalues" WHERE "id" = 1;
INSERT INTO "{PREFIX}site_tmplvar_contentvalues" VALUES ('1','3','9','demo miniblog howto tutorial posting');


DELETE FROM "{PREFIX}site_tmplvar_contentvalues" WHERE "id" = 2;
INSERT INTO "{PREFIX}site_tmplvar_contentvalues" VALUES ('2','3','18','demo older posting');
...
DELETE FROM "{PREFIX}system_settings" WHERE "setting_name" = 'error_page';
INSERT INTO "{PREFIX}system_settings" VALUES('error_page', '7');


DELETE FROM "{PREFIX}system_settings" WHERE "setting_name" = 'unauthorized_page';
INSERT INTO "{PREFIX}system_settings" VALUES('unauthorized_page', '4');
...
DELETE FROM "{PREFIX}web_groups" WHERE "id" = 1;
INSERT INTO "{PREFIX}web_groups" VALUES (1, 1, 1);
...
DELETE FROM "{PREFIX}web_user_attributes" WHERE "id" = 1;
INSERT INTO "{PREFIX}web_user_attributes" VALUES ('1','1','Site Admin',0,'you@example.com','','',0,0,0,'25','1129049624','1129063123',0,'f426f3209310abfddf2ee00e929774b4',0,0,'','','','','','');
...
DELETE FROM "{PREFIX}web_users" WHERE "id" = 1;
INSERT INTO "{PREFIX}web_users" VALUES ('1','siteadmin','5f4dcc3b5aa765d61d8327deb882cf99','');
...
DELETE FROM "{PREFIX}webgroup_access" WHERE "id" = 1;
INSERT INTO "{PREFIX}webgroup_access" VALUES ('1','1','1');
...
DELETE FROM "{PREFIX}webgroup_names" WHERE "id" = 1;
INSERT INTO "{PREFIX}webgroup_names" VALUES ('1','Site Admins');


DELETE FROM "{PREFIX}webgroup_names" WHERE "id" = 2;
INSERT INTO "{PREFIX}webgroup_names" VALUES ('2','Registered Users');
...
DROP TABLE IF EXISTS "{PREFIX}jot_content";
CREATE TABLE "{PREFIX}jot_content" ("id" bigserial NOT NULL , "title" varchar(255) default NULL, "tagid" varchar(50) default NULL, "published" smallint NOT NULL default 0, "uparent" integer NOT NULL default 0, "parent" integer NOT NULL default 0, "flags" varchar(25) default NULL, "secip" varchar(32) default NULL, "sechash" varchar(32) default NULL, "content" text, "customfields" text, "mode" smallint NOT NULL default '1', "createdby" integer NOT NULL default 0, "createdon" bigint NOT NULL default 0, "editedby" integer NOT NULL default 0, "editedon" bigint NOT NULL default 0, "deleted" smallint NOT NULL default 0, "deletedon" bigint NOT NULL default 0, "deletedby" integer NOT NULL default 0, "publishedon" bigint NOT NULL default 0, "publishedby" integer NOT NULL default 0, PRIMARY KEY ("id"));
CREATE INDEX "jot_content_parent" ON "{PREFIX}jot_content"("parent");
CREATE INDEX "jot_content_secip" ON "{PREFIX}jot_content"("secip");
CREATE INDEX "jot_content_parent" ON "{PREFIX}jot_content"("parent");
CREATE INDEX "jot_content_uparent" ON "{PREFIX}jot_content"("uparent");

--
-- Dumping data for table "jot_content"
--

DELETE FROM "{PREFIX}jot_content" WHERE "id" =9;
INSERT INTO "{PREFIX}jot_content" VALUES (9,'The first comment','','1','9',0,'','87.211.130.14','edb75dab198ff302efbf2f60e548c0b3',E'This is the first comment.','<custom><name></name><email></email></custom>',0,0,'1160420310',0,0,0,0,0,0,0);


DELETE FROM "{PREFIX}jot_content" WHERE "id" =10;
INSERT INTO "{PREFIX}jot_content" VALUES (10,'Second comment','','1','9',0,'','87.211.130.14','edb75dab198ff302efbf2f60e548c0b3',E'This is the second comment and uses an alternate row color. I also supplied a name, but i\'m not logged in.','<custom><name>Armand</name><email></email></custom>',0,0,'1160420453',0,0,0,0,0,0,0);


DELETE FROM "{PREFIX}jot_content" WHERE "id" =11;
INSERT INTO "{PREFIX}jot_content" VALUES (11,'No abuse','','1','9',0,'','87.211.130.14','edb75dab198ff302efbf2f60e548c0b3',E'Notice that I can\'t abuse <b>html</b>, ,  or [+placeholder+] tags.\r\n\r\nA new line also doesn\'t come unnoticed.','<custom><name>Armand</name><email></email></custom>',0,0,'1160420681',0,0,0,0,0,0,0);


DELETE FROM "{PREFIX}jot_content" WHERE "id" =12;
INSERT INTO "{PREFIX}jot_content" VALUES (12,'Posting when logged in','','1','9',0,'','87.211.130.14','58fade927c1df50ba6131f2b0e53c120',E'When you are logged in your own posts have a special color so you can easily spot them from the comment view. \r\n\r\nThe form also does not display any guest fields when logged in.','<custom></custom>',0,'-1','1160421310',0,0,0,0,0,0,0);


DELETE FROM "{PREFIX}jot_content" WHERE "id" =13;
INSERT INTO "{PREFIX}jot_content" VALUES (13,'Managers','','1','9',0,'','87.211.130.14','91e230cf219e3ade10f32d6a41d0bd4d',E'Comments posted when only logged in as a manager user will use your manager name.\r\n\r\nModerators options are always shown when you are logged in as manager user.','<custom></custom>',0,'1','1160421487',0,0,0,0,0,0,0);


DELETE FROM "{PREFIX}jot_content" WHERE "id" =15;
INSERT INTO "{PREFIX}jot_content" VALUES (14,'Moderation','','1','9',0,'','87.211.130.14','58fade927c1df50ba6131f2b0e53c120',E'In this setup the Site Admins group is defined as being the moderator for this particular comment view. These users will have extra moderation options \r\n\r\nManager users, Moderators or Trusted users can post bad words like: dotNet.','<custom></custom>',0,'-1','1160422081',0,0,0,0,0,0,0);


DELETE FROM "{PREFIX}jot_content" WHERE "id" =16;
INSERT INTO "{PREFIX}jot_content" VALUES (16,E'I\'m untrusted','',0,'9',0,'','87.211.130.14','edb75dab198ff302efbf2f60e548c0b3',E'Untrusted users however can NOT post bad words like: dotNet. When they do the posts will be unpublished.','<custom><name></name><email></email></custom>',0,0,'1160422167',0,0,0,0,0,0,0);
...
DROP TABLE IF EXISTS "{PREFIX}jot_subscriptions";
CREATE TABLE "{PREFIX}jot_subscriptions" ("id" bigserial NOT NULL, "uparent" integer NOT NULL default 0, "tagid" varchar(50) NOT NULL default '', "userid" integer NOT NULL default 0, PRIMARY KEY  ("id"));
CREATE INDEX "jot_subscriptions_uparent" ON "{PREFIX}jot_subscriptions"("uparent");
CREATE INDEX "jot_subscriptions_tagid" ON "{PREFIX}jot_subscriptions"("tagid");
CREATE INDEX "jot_subscriptions_userid" ON "{PREFIX}jot_subscriptions"("userid");
