...
$_lang["clean_uploaded_filename"] = 'Gebruik vertaling voor het uploaden van bestanden';
$_lang["clean_uploaded_filename_message"] = 'Gebruik standaard of transalias instellingen voor de bestandsnaam om speciale tekens te verwijderen van geüploade bestandsnamen, met behoud van punt-tekens (periodes)';
...
$_lang["configcheck_hide_warning"] = '<a href="javascript:hideConfigCheckWarning(\'%s\');"><em>Niet opnieuw tonen.</em></a>';
...
$_lang["configcheck_php_gdzip_msg"] = 'De GD en Zip extensie moet aan staan voor PHP. MODx werkt niet zonder deze extenties, u zal niet volledig gebruik kunnen maken van de ingebouwde Bestands Manager, Afbeeldingen aanpassen of Captcha voor login kunnen gebruiken.';
...
$_lang["configcheck_templateswitcher_present_disable"] = '<a href="javascript:disableTemplateSwitcher();">Zet TemplateSwitcher uit</a>';
$_lang["configcheck_templateswitcher_present_msg"] = 'De TemplateSwitcher plugin geeft caching en performance problemen, en zou alleen moeten worden gebruikt wanneer u deze functionaliteit nodig heeft.';
...
$_lang["configcheck_validate_referer_msg"] = "The configuratie instelling <strong>Validate HTTP_REFERER headers?</strong> staat uit. We adviseren dat u deze aan inschakelt. <a href=\"index.php?a=17\">Ga naar de Configuratie opties</a>";
